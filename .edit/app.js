...
{				
	...
	this.SendIntent = function( packageName,className,action,category,uri,type,extras,options,callback ) { prompt( "#", "App.SendIntent(\f"+packageName+"\f"+className+"\f"+action+"\f"+category+"\f"+uri+"\f"+type+"\f"+extras+"\f"+options+"\f"+(callback?callback.name:null) ); }
	...
	this.SetOnError = function( callback ) { prompt( "#", "App.SetOnError(\f"+(callback?callback.name:null) ); }
	this.SetOnDebug = function( callback ) { prompt( "#", "App.SetOnDebug(\f"+(callback?callback.name:null) ); }
	...
	this.SetOnBroadcast = function( callback ) { prompt( "#", "App.SetOnBroadcast("+(callback?callback.name:null) ); }
	...
	this.TextToSpeech = function( text,pitch,rate,callback,stream,locale ) { prompt( "#", "App.TextToSpeech(\f"+text+"\f"+pitch+"\f"+rate+"\f"+(callback?callback.name:null)+"\f"+stream+"\f"+locale ); }
	...
	this.UploadFile = function( url,file,name,callback ) { prompt( "#", "App.UploadFile(\f"+url+"\f"+file+"\f"+name+"\f"+(callback?callback.name:null) ); }
...
function Obj( id )
{
    ...
    this.SetPadding = function( left,top,right,bottom ) { prompt( this.id, "Obj.SetPadding("+left+"\f"+top+"\f"+right+"\f"+bottom ); }
    ...
    this.SetPosition = function( left,top,width,height,options ) { prompt( this.id, "Obj.SetPosition(\f"+left+"\f"+top+"\f"+width+"\f"+height+"\f"+options ); }
...
function Lay( id )
{
    ...
    obj.SetOrientation = function( orient ) { prompt( obj.id, "Lay.SetOrientation("+orient ); }    
    ...
    obj.Animate = function( type,callback,time ) { prompt( obj.id, "Lay.Animate(\f"+type+"\f"+(callback?callback.name:null)+"\f"+time ); }
    obj.SetTouchable = function( touchable ) { prompt( obj.id, "Lay.SetTouchable("+touchable ); }
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Lay.SetOnTouch("+(callback?callback.name:null) ); } 
    obj.SetOnTouchUp = function( callback ) { prompt( obj.id, "Lay.SetOnTouchUp("+(callback?callback.name:null) ); }  
    obj.SetOnTouchMove = function( callback ) { prompt( obj.id, "Lay.SetOnTouchMove("+(callback?callback.name:null) ); }
    obj.SetOnTouchDown = function( callback ) { prompt( obj.id, "Lay.SetOnTouchDown("+(callback?callback.name:null) ); } 
    obj.SetOnLongTouch = function( callback ) { prompt( obj.id, "Lay.SetOnLongTouch("+(callback?callback.name:null) ); } 
    return obj;
}
...
function Img( id )
{
    ...
    obj.Update2 = function() { if( obj._auto ) prompt( obj.id, "Img.Update(" ); else { prompt( obj.id, "Img.Batch2("+obj._gfb ); obj._gfb = ""; } }
    ...
    obj.SetSize = function( width,height ) { prompt( this.id, "Img.SetSize("+width+"\f"+height ); }
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Img.SetOnTouch("+(callback?callback.name:null) ); } 
    obj.SetOnTouchUp = function( callback ) { prompt( obj.id, "Img.SetOnTouchUp("+(callback?callback.name:null) ); }  
    obj.SetOnTouchMove = function( callback ) { prompt( obj.id, "Img.SetOnTouchMove("+(callback?callback.name:null) ); }
    obj.SetOnTouchDown = function( callback ) { prompt( obj.id, "Img.SetOnTouchDown("+(callback?callback.name:null) ); } 
    obj.SetOnLongTouch = function( callback ) { prompt( obj.id, "Img.SetOnLongTouch("+(callback?callback.name:null) ); } 
    obj.SetOnLoad = function( callback ) { prompt( obj.id, "Img.SetOnLoad\f"+(callback?callback.name:null) ); }   
...
function Btn( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Btn.SetOnClick("+(callback?callback.name:null) ); }
    obj.SetOnTouchEx = function( callback ) { prompt( obj.id, "Btn.SetOnClick("+(callback?callback.name:null) ); }
...
function Tgl( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Tgl.SetOnClick("+(callback?callback.name:null) ); }
...
function Chk( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Chk.SetOnClick("+(callback?callback.name:null) ); }
    ...
    obj.AdjustColor = function( hue,sat,bright,cont ) { prompt( this.id, "Chk.AdjustColor(\f"+hue+"\f"+sat+"\f"+bright+"\f"+cont ); }
    return obj;      
}
...
function Spn( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Spn.SetOnClick("+(callback?callback.name:null) ); }
    obj.SetOnChange = function( callback ) { prompt( obj.id, "Spn.SetOnClick("+(callback?callback.name:null) ); }
    ...
    obj.AdjustColor = function( hue,sat,bright,cont ) { prompt( this.id, "Spn.AdjustColor(\f"+hue+"\f"+sat+"\f"+bright+"\f"+cont ); }
    return obj;
}
...
function Skb( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Skb.SetOnClick("+(callback?callback.name:null) ); }
    ...
    obj.AdjustColor = function( hue,sat,bright,cont ) { prompt( this.id, "Skb.AdjustColor(\f"+hue+"\f"+sat+"\f"+bright+"\f"+cont ); }
    return obj;
}
...
function Ibn( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Ibn.SetOnClick("+(callback?callback.name:null) ); }
...
function Txt( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Txt.SetOnTouch("+(callback?callback.name:null) ); } 
    obj.SetOnTouchUp = function( callback ) { prompt( obj.id, "Txt.SetOnTouchUp("+(callback?callback.name:null) ); }  
    obj.SetOnTouchMove = function( callback ) { prompt( obj.id, "Txt.SetOnTouchMove("+(callback?callback.name:null) ); }
    obj.SetOnTouchDown = function( callback ) { prompt( obj.id, "Txt.SetOnTouchDown("+(callback?callback.name:null) ); } 
    obj.SetOnLongTouch = function( callback ) { prompt( obj.id, "Txt.SetOnLongTouch("+(callback?callback.name:null) ); }   
...
function Txe( id )
{
    ...
    obj.SetOnChange = function( callback ) { prompt( obj.id, "Txe.SetOnChange(\f"+(callback?callback.name:null) ); }  
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Txe.SetOnTouch(\f"+(callback?callback.name:null) ); }  
    obj.SetOnEnter = function( callback ) { prompt( obj.id, "Txe.SetOnEnter(\f"+(callback?callback.name:null) ); }  
...
function Cde( id )
{
    ...
    obj.SetOnChange = function( callback ) { prompt( obj.id, "Cde.SetOnChange(\f"+(callback?callback.name:null) ); }  
    obj.SetOnDoubleTap = function( callback ) { prompt( obj.id, "Cde.SetOnDoubleTap(\f"+(callback?callback.name:null) ); } 
...
function Lst( id )
{
    ...
    obj.SetPadding = function( left,top,right,bottom ) { prompt( this.id, "Lst.SetPadding("+left+"\f"+top+"\f"+right+"\f"+bottom ); }
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Lst.SetOnClick("+(callback?callback.name:null) ); }    
    obj.SetOnLongTouch = function( callback ) { prompt( obj.id, "Lst.SetOnLongClick("+(callback?callback.name:null) ); }    
    ...
    obj.SetTextMargins = function( left,top,right,bottom ) { prompt( this.id, "Lst.SetTextMargins("+left+"\f"+top+"\f"+right+"\f"+bottom ); }
	...
	obj.AdjustColor = function( hue,sat,bright,cont ) { prompt( this.id, "Lst.AdjustColor(\f"+hue+"\f"+sat+"\f"+bright+"\f"+cont ); }
    return obj;
}
...
function Web( id )
{
    ...
    obj.SetOnProgress = function( callback ) { prompt( obj.id, "Web.SetOnProgress("+(callback?callback.name:null) ); }  
...
function Dlg( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Dlg.SetOnClick("+(callback?callback.name:null) ); }
	...
	obj.SetOnCancel = function( callback ) { prompt( obj.id, "Dlg.SetOnCancel(\f"+(callback?callback.name:null) ); }
	return obj;
}
...
function Ynd( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Ynd.SetOnClick("+(callback?callback.name:null) ); }
	...
	obj.AdjustColor = function( hue,sat,bright,cont ) { prompt( this.id, "Ynd.AdjustColor(\f"+hue+"\f"+sat+"\f"+bright+"\f"+cont ); }
    return obj;
}
...
function Lvw( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Lvw.SetOnClick("+(callback?callback.name:null) ); }   
    return obj; 
}
...
function Ldg( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Ldg.SetOnClick("+(callback?callback.name:null) ); }
...
function Btl( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Btl.SetOnClick("+(callback?callback.name:null) ); }
...
function Net( id )
{
    ...
    obj.SetOnConnect = function( callback ) { prompt( obj.id, "Net.SetOnConnect("+(callback?callback.name:null) ); }
    ...
    obj.SetOnDownload = function( callback ) { prompt( obj.id, "Net.SetOnDownload("+(callback?callback.name:null) ); }    
    ...
    obj.SetOnReceive = function( callback ) { prompt( obj.id, "Net.SetOnReceive("+(callback?callback.name:null) ); }           
...
function Aud( id )
{
    ...
    obj.SetOnReady = function( callback ) { prompt( obj.id, "Aud.SetOnReady("+(callback?callback.name:null) ); } 
    obj.SetOnComplete = function( callback ) { prompt( obj.id, "Aud.SetOnComplete("+(callback?callback.name:null) ); }    
    obj.SetOnSeekDone = function( callback ) { prompt( obj.id, "Aud.SetOnSeekDone("+(callback?callback.name:null) ); }  
    return obj;  
}
...
function Dwn( id )
{
    ...
    obj.SetOnComplete = function( callback ) { prompt( obj.id, "Dwn.SetOnComplete(\f"+(callback?callback.name:null) ); }  
    obj.SetOnError = function( callback ) { prompt( obj.id, "Dwn.SetOnError(\f"+(callback?callback.name:null) ); }    
    return obj;  
}
...
function Med( id )
{
    ...
    obj.SetOnMediaResult = function( callback ) { prompt( obj.id, "Med.SetOnMediaResult(\f"+(callback?callback.name:null) ); } 
    obj.QueryArtists = function( filter,sort,options ) { prompt( obj.id, "Med.QueryArtists(\f"+filter+"\f"+sort+"\f"+options ); }
    obj.SetOnArtistsResult = function( callback ) { prompt( obj.id, "Med.SetOnArtistsResult(\f"+(callback?callback.name:null) ); } 
    obj.QueryAlbums = function( filter,sort,options ) { prompt( obj.id, "Med.QueryAlbums(\f"+filter+"\f"+sort+"\f"+options ); }
    obj.SetOnAlbumsResult = function( callback ) { prompt( obj.id, "Med.SetOnAlbumsResult(\f"+(callback?callback.name:null) ); } 
...
function Ply( id )
{
    ...
    obj.GetBillingInfo = function( prodIDs,callback,options ) { ret = prompt( obj.id, "Ply.GetBillingInfo(\f"+prodIDs+"\f"+(callback?callback.name:null)+"\f"+options ); }
    obj.Purchase = function( prodID,token,callback,options ) { ret = prompt( obj.id, "Ply.Purchase(\f"+prodID+"\f"+token+"\f"+(callback?callback.name:null)+"\f"+options ); }
    obj.GetPurchases = function( callback,options ) { ret = prompt( obj.id, "Ply.GetPurchases(\f"+(callback?callback.name:null)+"\f"+options ); }
    return obj;  
}
...
function Sns( id )
{
    ...
    obj.SetOnChange = function( callback ) { prompt( obj.id, "Sns.SetOnChange("+(callback?callback.name:null) ); } 
...
function Loc( id )
{
    ...
    obj.SetOnChange = function( callback ) { prompt( obj.id, "Loc.SetOnChange("+(callback?callback.name:null) ); } 
...
function Pst( id )
{
    ...
    obj.SetOnChange = function( callback ) { prompt( obj.id, "Pst.SetOnChange("+(callback?callback.name:null) ); } 
...
function Cam( id )
{
    ...
    obj.SetOnReady = function( callback ) { prompt( obj.id, "Cam.SetOnReady("+(callback?callback.name:null) ); }
    obj.SetOnMotion = function( callback ) { prompt( obj.id, "Cam.SetOnMotion("+(callback?callback.name:null) ); }
    obj.SetOnPicture = function( callback ) { prompt( obj.id, "Cam.SetOnPicture\f"+(callback?callback.name:null) ); }
    obj.SetOnFocus = function( callback ) { prompt( obj.id, "Cam.SetOnFocus\f"+(callback?callback.name:null) ); } 
...
function Vid( id )
{
    ...
    obj.SetOnReady = function( callback ) { prompt( obj.id, "Vid.SetOnReady("+(callback?callback.name:null) ); } 
    obj.SetOnComplete = function( callback ) { prompt( obj.id, "Vid.SetOnComplete("+(callback?callback.name:null) ); }    
    obj.SetOnError = function( callback ) { prompt( obj.id, "Vid.SetOnError("+(callback?callback.name:null) ); }
    return obj;   
}
...
function GLV( id )
{
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "GLV.SetOnTouch(\f"+(callback?callback.name:null) ); } 
    obj.SetOnTouchUp = function( callback ) { prompt( obj.id, "GLV.SetOnTouchUp(\f"+(callback?callback.name:null) ); }  
    obj.SetOnTouchMove = function( callback ) { prompt( obj.id, "GLV.SetOnTouchMove(\f"+(callback?callback.name:null) ); }
    obj.SetOnTouchDown = function( callback ) { prompt( obj.id, "GLV.SetOnTouchDown(\f"+(callback?callback.name:null) ); } 
...
function WGL( id )
{
    ...
    obj.Exec = function( p1,p2,p3,p4 ) { _gfx.Exec( p1,p2,p3,p4 ); }
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "WGL.SetOnTouch(\f"+(callback?callback.name:null) ); } 
    obj.SetOnTouchUp = function( callback ) { prompt( obj.id, "WGL.SetOnTouchUp(\f"+(callback?callback.name:null) ); }  
    obj.SetOnTouchMove = function( callback ) { prompt( obj.id, "WGL.SetOnTouchMove(\f"+(callback?callback.name:null) ); }
    obj.SetOnTouchDown = function( callback ) { prompt( obj.id, "WGL.SetOnTouchDown(\f"+(callback?callback.name:null) ); } 
...
function Nxt( id, nxtHelper )
{
    ...
    obj.SetOnConnect = function( callback ) { prompt( obj.id, "Nxt.SetOnConnect("+(callback?callback.name:null) ); }
...
function Bts( id )
{
    ...
    obj.SetOnConnect = function( callback ) { prompt( obj.id, "Bts.SetOnConnect("+(callback?callback.name:null) ); }
    ...
    obj.SetOnReceive = function( callback ) { prompt( obj.id, "Bts.SetOnReceive("+(callback?callback.name:null) ); }   
...
function Spr( id )
{
    ...
    obj.SetOnReady = function( callback ) { prompt( obj.id, "Spr.SetOnReady(\f"+(callback?callback.name:null) ); } 
    obj.SetOnResult = function( callback ) { prompt( obj.id, "Spr.SetOnResult(\f"+(callback?callback.name:null) ); } 
    obj.SetOnError = function( callback ) { prompt( obj.id, "Spr.SetOnError(\f"+(callback?callback.name:null) ); } 
   	return obj;
}
...
function SMS( id )
{
	...
	obj.SetOnStatus = function( callback ) { prompt( obj.id, "SMS.SetOnStatus("+(callback?callback.name:null) ); }
	obj.SetOnMessage = function( callback ) { prompt( obj.id, "SMS.SetOnMessage("+(callback?callback.name:null) ); }
	return obj;
}
...
function EMAIL( id )
{
	...
	obj.SetOnStatus = function( callback ) { prompt( obj.id, "EML.SetOnStatus("+(callback?callback.name:null) ); }
	obj.SetOnMessage = function( callback ) { prompt( obj.id, "EML.SetOnMessage("+(callback?callback.name:null) ); }
	return obj;
}
...
function Wbs( id )
{
    ...
    obj.AddServlet = function( path,callback ) { prompt( obj.id, "Wbs.AddServlet("+path+"\f"+(callback?callback.name:null) ); }
    ...
    obj.SetOnReceive = function( callback ) { prompt( obj.id, "Wbs.SetOnReceive(\f"+(callback?callback.name:null) ); }  
    return obj;
}
...
function Usb( id )
{
    ...
    obj.SetOnReceive = function( callback ) { prompt( obj.id, "Usb.SetOnReceive("+(callback?callback.name:null) ); }  
...
function Svc( id )
{
	...
	obj.SetOnMessage = function( callback ) { prompt( obj.id, "Svc.SetOnMessage(\f"+(callback?callback.name:null) ); }
    return obj;
}
